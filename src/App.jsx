    ...
    <div>
      ...
      <div id="recettes">
        {recettes.map((recette) => (
          <Recette key={recette.id} id={recette.id} titre={recette.titre} ingredients={recette.ingredients} temps={recette.temps} methode={recette.methode} modifierRecette={fillForm} supprimerRecette={supprimerRecette}></Recette>
        ))}
      </div>
    </div>
  );
